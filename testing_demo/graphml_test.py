...
# main function
def visualize_graphml(graphml_file, html_path, port=8001):
...
if __name__ == "__main__":
    create_html("graph_visualization.html")
    graphml_file = f"./traffic_law_deepseek_vietnamese/graph_chunk_entity_relation.graphml"  # replace with your GraphML file path
    html_path = "./graph_visualization.html"
    visualize_graphml(graphml_file, html_path, 8001)